...
- Node id: `hapa-spaceship-desktop-hijack`
- Repo name: `hapa-spaceship-desktop-hijack`
- Hapa system group: `apps` (Apps)
- Target assembly path: `hapa-system/apps/hapa-spaceship-desktop-hijack`
...
- Review 2 dirty working-tree entries before pinning.
